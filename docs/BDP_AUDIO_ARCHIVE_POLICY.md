...
This document establishes the rules for incorporating Ian Buchanan’s spoken material (lectures, interviews, podcasts) into The Dark Precursor platform.
...
- Machinic Unconscious Happy Hour – Ian Buchanan on *Assemblage Theory and Method* (2024)
- Ian Buchanan keynote: *Deleuze and Guattari’s Differential Method* (Prague, 2022)
- Ian Buchanan keynote: *What is Affect?* (2023)

Any new source must be reviewed and recorded in this document before integration.

## Governance

- No audio file may be uploaded to the platform without prior approval via patch + documentation update.
- All audio-related changes must follow the standard patch workflow.
